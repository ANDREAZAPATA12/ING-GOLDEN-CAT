   ...
   <v-subheader class="subheader black--text display-1 font-weight-bold ">Habitaciones</v-subheader>
            ...
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6 md4>
                 ...
                 <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.tipohabitacio" label="tipo habitacion"></v-text-field>
                </v-flex>
              </v-layout>
            </v-container>
          </v-card-text>
    ...
    >
      <template v-slot:items="props">
        ...
        <td class="text-xs-left">{{ props.item.tipohabitacion }}</td>
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Valor por Cabeza', value: 'VCabeza' },
       { text: 'tipo habitacion', value: 'tipohabitacion' },
...
.botones{
  height: 70px;
    width: 297px;
    margin: -268px -297px 295px 695px;
}
