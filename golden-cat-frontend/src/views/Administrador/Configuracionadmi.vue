<template>
  <v-flex>
    ...
    <div class="  text-xs-center" style="padding-bottom: 15px; padding-top: 15px">
      <span class="font-weight-black:bold, display-1" >EDITA TU PERFIL</span>
    </div>
    <v-spacer></v-spacer>
    <v-container fluid class="color2">
    <v-layout row style="padding-left:300px">
    ...
    <v-layout row>
      ...
      <v-flex xs3 order-lg2>
        <v-text-field small label="" solo v-model="user.phone"></v-text-field>
      </v-flex>
    </v-layout>
    <v-divider> </v-divider>
    <v-card-text class="transparent text-xs-center">
