<template>
  <v-app id="inspire" dark>
    <v-toolbar app color="#01579B">
        ...
        <div color="red"  class="text-xs-center">
    <v-menu posicion-x >
